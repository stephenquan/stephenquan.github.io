...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__Z5sayHiv')) {
        Object.defineProperty(Module['ready'], '__Z5sayHiv', { configurable: true, get: function() { abort('You are getting __Z5sayHiv on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__Z5sayHiv', { configurable: true, set: function() { abort('You are setting __Z5sayHiv on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
  wasmBinaryFile = 'qmlonline6.wasm';
  wasmBinaryFile = 'https://www.arcgis.com/sharing/rest/content/items/ca7802e9426e4a4f9cb2e87ff9f54048/data';
...
/** @type {function(...*):?} */
var __Z5sayHiv = Module["__Z5sayHiv"] = createExportWrapper("_Z5sayHiv");
