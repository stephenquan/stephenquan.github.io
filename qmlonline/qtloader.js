...
function QtLoader(config)
{
    ...
    function fetchThenCompileWasm(response) {
        console.log("fetchThenCompileWasm");
    ...
    function fetchCompileWasm(filePath) {
        console.log("fetchCompileWasm", filePath);
        return fetchResource(filePath).then(function(response) {
    ...
    function loadEmscriptenModule(applicationName) {
        ...
        //let wasmBinaryName = applicationName + ".wasm";
        let wasmBinaryName = 'https://www.arcgis.com/sharing/rest/content/items/066c7e5773fc4b87beffbbea56fad4c4/data';
        console.log("wasmBinaryName: ", wasmBinaryName);
        var wasmModulePromise = fetchCompileWasm(wasmBinaryName).then(function (module) {
            wasmModule = module;
        });
